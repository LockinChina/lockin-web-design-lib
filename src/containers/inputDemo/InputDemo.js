    ...
    <div>
      ...
      <Table className="w">
        ...
        <tbody>
          ...
          <tr><td>type</td><td>文本类型: text password number tel mail...</td><td>string</td><td>text</td></tr>
          ...
          <tr><td>onChange</td><td>文本框onChange函数 带一个参数: 本文输入当前值</td><td>function</td><td>/</td></tr>
          ...
          <tr><td>inputBackgroundColor</td><td>设置文本框边框背景色 </td><td>string</td><td>#fff</td></tr>
