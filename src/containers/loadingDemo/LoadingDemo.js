  ...
  return (
    <div>
      <GrayBox>
        <Ptit>Loading</Ptit>
        <Space />
        <Button hollow titleName = "点我开始Loading..." onClick={()=> setMask(true)} />
        {
      ...
      <Table className="w">
        ...
        <tbody>
          <tr><td>transparent</td><td>是否显示遮罩</td><td>boolean</td><td>true</td></tr>
          <tr><td>opacity</td><td>设置遮罩透明度 取值0-1 设置为0时等同于transparent={`{true}`} </td><td>number</td><td>0.2</td></tr>
